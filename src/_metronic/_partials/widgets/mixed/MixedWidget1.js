...
export function MixedWidget1({ className, statisticType }) {
        ...
        <div className="card-spacer mt-n25">
          <div className="row m-0">
            <div className="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
              ...
              <a
                // href="#"
                onClick={() => statisticType("most-practiced-users")}
                className="text-warning font-weight-bold font-size-h6"
              >
                Most Practiced Users
              </a>
            </div>
            <div className="col bg-light-primary px-6 py-8 rounded-xl mr-7 mb-7">
              ...
              <a
                // href="#"
                onClick={() => statisticType("online-users")}
            ...
            <div className="col bg-light-danger px-6 py-8 rounded-xl mr-7 mb-7">
              ...
              <a
                // href="#"
                onClick={() => statisticType("most-reported-exam-questions")}
                className="text-danger font-weight-bold font-size-h6 mt-2"
              >
                Most Reported Exam Questions
              </a>
            </div>
            <div className="col bg-light-success px-6 py-8 rounded-xl mb-7">
              ...
              <a
                // href="#"
                onClick={() =>
                  statisticType("most-reported-difficult-questions")
                }
                className="text-success font-weight-bold font-size-h6 mt-2"
              >
                Most Reported Difficult Questions
              </a>
            </div>
          </div>
          <div className="row m-0">
            <div className="col bg-light-danger px-6 py-8 rounded-xl mr-7 mb-7">
              ...
              <a
                // href="#"
                onClick={() => statisticType("most-practiced-questions")}
            ...
            <div className="col bg-light-success px-6 py-8 rounded-xl mr-7 mb-7">
              ...
              <a
                // href="#"
                onClick={() => statisticType("most-practiced-mock-tests")}
                className="text-success font-weight-bold font-size-h6 mt-2"
              >
                Most Practiced Mock Tests
              </a>
            </div>
            {/* </div>
          <div className="row m-0"> */}
            ...
            <div className="col bg-light-primary px-6 py-8 rounded-xl mr-7 mb-7">
              ...
              <a
                // href="#"
                onClick={() => statisticType("most-purchased-packages")}
                className="text-primary font-weight-bold font-size-h6 mt-2"
              >
            ...
            {/* <div className="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
              ...
              <a
                // href="#"
                onClick={() =>
                  statisticType("most-purchased-subscription-types")
                }
                className="text-warning font-weight-bold font-size-h6 mt-2"
              >
                Most Purchased Subscription Types
              </a>
            </div> */}
            <div className="col  px-6 py-8 rounded-xl mr-7 mb-7" style={{backgroundColor:"#fff"}}>
              <span className="svg-icon svg-icon-3x svg-icon-warning d-block my-2">
