...
export default function EnhancedTable({
  ...
  const getQuestionLink = (q) => {
    console.log("getQuestionLink")
    switch (q?.question_type) {
      case "ReadingMultipleChoiceSingleAnswer":
        return `/knowledge-tests-mcsa/${q?.id}/edit`;
      case "ReadingMultipleChoiceMultipleAnswer":
        return `/knowledge-tests-mcma/${q?.id}/edit`;
    }
  };
        ...
        <>
                        ...
                        return (
                          ...
                          >
                            ...
                            <TableCell
                              ...
                              padding="none"
                            >
                              <Link to={getQuestionLink(row)}>{row.title}</Link>
                            </TableCell>
          ...
          <TablePagination
            ...
            onChangePage={(e, number) => {
              ...
              if (!isExistTable)
                dispatch(
                  actions.fetchFilteredKnowledgeTest({
                    ...filterValues,
                    page: number + 1,
