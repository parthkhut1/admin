...
const WriteEssayCorrection = ({ question, correctionData }) => {
      ...
      <div className="form-group row">
        <div className={`col-lg-5`}>
          <TextField
            ...
            id="outlined-basic 7"
            type="number"
            label="Score General Linguistic Range"
            name="score_general_linguistic_range"
            onChange={onInputChange}
            variant="outlined"
          />
        </div>
        <div className={`col-lg-5`}>
          <TextField
            ...
            id="outlined-basic 8"
            type="number"
            name="Score Development Structure Coherence"
            label="score_development_structure_coherence"
            onChange={onInputChange}
            variant="outlined"
          />
        </div>
      ...
      <div className="form-group row">
        ...
        <div className={`col-lg-5`}>
          <TextField
            ...
            type="number"
            label="Score Writing Discourse Enabling Skills"
            name="score_writing_discourse_enabling_skills"
            onChange={onInputChange}
            variant="outlined"
          />
        </div>
...
export default WriteEssayCorrection;
