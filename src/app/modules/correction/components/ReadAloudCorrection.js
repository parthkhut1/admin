...
const ReadAloudCorrection = ({ question, correctionData }) => {
      ...
      <div className="form-group row">
        ...
        <div className={`col-lg-5`}>
          <TextField
            ...
            id="outlined-basic 6"
            type="number"
            label="Score Reading Communicative Skills"
            name="score_reading_communicative_skills"
            onChange={onInputChange}
            variant="outlined"
          />
        </div>
      ...
      <div className="form-group row">
        ...
        <div className={`col-lg-3`}>
          <TextField
            ...
            type="number"
            name="omissions_count"
            label="Omissions Count"
            onChange={onInputChange}
            variant="outlined"
          />
        </div>
...
export default ReadAloudCorrection;
