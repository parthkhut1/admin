...
const dispatch = useDispatch();
  const questionsUIEvents = {
    newQuestionButtonClick: () => {
      history.push("/knowledge-tests-mcma/new");
    },
    openEditQuestionDialog: (id) => {
      history.push(`/knowledge-tests-mcma/${id}/edit`);
    },
    openDeleteQuestionDialog: (id) => {
      history.push(`/knowledge-tests-mcma/${id}/delete`);
    },
    openAddToMockDialog: (id) => {
      history.push(
        `/knowledge-tests-mcma/${id}/add-to-mock-test`
      );
    },
    openDeleteQuestionsDialog: () => {
      history.push(`/knowledge-tests-mcma/deleteCustomers`);
    },
    openFetchQuestionsDialog: () => {
      history.push(`/knowledge-tests-mcma/fetch`);
    },
    openUpdateQuestionsStatusDialog: () => {
      history.push("/knowledge-tests-mcma/updateStatus");
    },
  };
  ...
  return (
    <QuestionsUIProvider questionsUIEvents={questionsUIEvents}>
      ...
      <Switch>
        <Route path="/knowledge-tests-mcma/new">
          {({ history, match }) => (
            <QuestionEditDialog
              show={match != null}
              onHide={() => {
                ...
                history.push("/knowledge-tests-mcma");
              }}
            />
          )}
        </Route>
        <Route path="/knowledge-tests-mcma/:id/edit">
          {({ history, match }) => (
            <QuestionEditDialog
              show={match != null}
        ...
        <Route path="/knowledge-tests-mcma/:id/add-to-mock-test">
          {({ history, match }) => (
        ...
        <Route path="/knowledge-tests-mcma/deleteCustomers">
          {({ history, match }) => (
        ...
        <Route path="/knowledge-tests-mcma/:id/delete">
          {({ history, match }) => (
        ...
        <Route path="/knowledge-tests-mcma/fetch">
          {({ history, match }) => (
        ...
        <Route path="/knowledge-tests-mcma/updateStatus">
          {({ history, match }) => (
