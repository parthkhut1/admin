...
export function QuestionEditDialog({ id, show, onHide }) {
  ...
  const { actionsLoading, questionForEdit } = useSelector(
    (state) => ({
      actionsLoading: state.multipleChoiceMultipleAnswers.actionsLoading,
      questionForEdit: state.multipleChoiceMultipleAnswers.questionForEdit,
    }),
    shallowEqual
  );
