...
export function UsersTable() {
  ...
  const usersUIProps = useMemo(() => {
    return {
      ...
      onGuestLogin: usersUIContext.onGuestLogin
    };
  }, [usersUIContext]);
  ...
  const gusetLogin = () => {
    ...
    formData.append("email", "hotad45444@niback.com")
    dispatch(actions.guestLoginAction(formData));
  }
  // Table columns
  const columns = [
    {
    ...
    {
      dataField: "date_of_exam",
      text: "Study-Plan exam date",
      sort: false,
      sortCaret: sortCaret,
      headerSortingClasses,
      classes: "text-center",
    ...
    // },
    {
      ...
      formatExtraData: {
        ...
        onGuestLogin: () => { gusetLogin() }
        // onGuestLogin: usersUIProps.onGuestLogin
      },
