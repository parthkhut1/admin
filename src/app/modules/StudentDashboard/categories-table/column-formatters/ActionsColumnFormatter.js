...
export const ActionsColumnFormatter = (
  ...
  row,
  rowIndex,
  { openEditCategoryDialog, openDeleteCategoryDialog }
) => {
  // categorys Redux state
  // const dispatch = useDispatch();
  // const { actionsLoading, categoryForEdit } = useSelector(
  //   (state) => ({
  //     actionsLoading: state.categorys.actionsLoading,
  //     categoryForEdit: state.categorys.categoryForEdit,
  //   }),
  //   shallowEqual
  // );
  return (
    <>
      {/* <a
        ...
        href={`${categoryForEdit?.holder_data?.start_url}`}
      >
