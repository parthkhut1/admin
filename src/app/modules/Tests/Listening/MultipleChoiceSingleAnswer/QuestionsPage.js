...
const dispatch = useDispatch();
  const questionsUIEvents = {
    newQuestionButtonClick: () => {
      history.push("/listening/multiple-choice-single-answer/new");
    },
    openEditQuestionDialog: (id) => {
      history.push(`/listening/multiple-choice-single-answer/${id}/edit`);
    },
    openAddToMockDialog: (id) => {
      history.push(
        `/listening/multiple-choice-single-answer/${id}/add-to-mock-test`
      );
    },
    openDeleteQuestionDialog: (id) => {
      history.push(`/listening/multiple-choice-single-answer/${id}/delete`);
    },
    openDeleteQuestionsDialog: () => {
      history.push(`/listening/multiple-choice-single-answer/deleteCustomers`);
    },
    openFetchQuestionsDialog: () => {
      history.push(`/listening/multiple-choice-single-answer/fetch`);
    },
    openUpdateQuestionsStatusDialog: () => {
      history.push("/listening/multiple-choice-single-answer/updateStatus");
    },
  };
  ...
  return (
    <QuestionsUIProvider questionsUIEvents={questionsUIEvents}>
      ...
      <Switch>
        <Route path="/listening/multiple-choice-single-answer/new">
          {({ history, match }) => (
            <QuestionEditDialog
              show={match != null}
              onHide={() => {
                ...
                history.push("/listening/multiple-choice-single-answer");
              }}
            />
          )}
        </Route>
        <Route path="/listening/multiple-choice-single-answer/:id/edit">
          {({ history, match }) => (
            <QuestionEditDialog
              show={match != null}
        ...
        <Route path="/listening/multiple-choice-single-answer/deleteCustomers">
          {({ history, match }) => (
        ...
        <Route path="/listening/multiple-choice-single-answer/:id/add-to-mock-test">
          {({ history, match }) => (
        ...
        <Route path="/listening/multiple-choice-single-answer/:id/delete">
          {({ history, match }) => (
        ...
        <Route path="/listening/multiple-choice-single-answer/fetch">
          {({ history, match }) => (
        ...
        <Route path="/listening/multiple-choice-single-answer/updateStatus">
          {({ history, match }) => (
