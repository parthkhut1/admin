...
const dispatch = useDispatch();
  const questionsUIEvents = {
    newQuestionButtonClick: () => {
      history.push("/speaking/describe-image/new");
    },
    openEditQuestionDialog: (id) => {
      history.push(`/speaking/describe-image/${id}/edit`);
    },
    openAddToMockDialog: (id) => {
      history.push(`/speaking/describe-image/${id}/add-to-mock-test`);
    },
    openDeleteQuestionDialog: (id) => {
      history.push(`/speaking/describe-image/${id}/delete`);
    },
    openDeleteQuestionsDialog: () => {
      history.push(`/speaking/describe-image/deleteCustomers`);
    },
    openFetchQuestionsDialog: () => {
      history.push(`/speaking/describe-image/fetch`);
    },
    openUpdateQuestionsStatusDialog: () => {
      history.push("/speaking/describe-image/updateStatus");
    },
  };
  ...
  return (
    <QuestionsUIProvider questionsUIEvents={questionsUIEvents}>
      ...
      <Switch>
        <Route path="/speaking/describe-image/new">
          {({ history, match }) => (
            <QuestionEditDialog
              show={match != null}
              onHide={() => {
                ...
                history.push("/speaking/describe-image");
              }}
            />
          )}
        </Route>
        <Route path="/speaking/describe-image/:id/edit">
          {({ history, match }) => (
            <QuestionEditDialog
              show={match != null}
        ...
        <Route path="/speaking/describe-image/deleteCustomers">
          {({ history, match }) => (
        ...
        <Route path="/speaking/describe-image/:id/add-to-mock-test">
          {({ history, match }) => (
        ...
        <Route path="/speaking/describe-image/:id/delete">
          {({ history, match }) => (
        ...
        <Route path="/speaking/describe-image/fetch">
          {({ history, match }) => (
        ...
        <Route path="/speaking/describe-image/updateStatus">
          {({ history, match }) => (
