...
export function QuestionEditForm({
  ...
  const [answerInputLink, setAnswerInputLink] = useState("");
  ...
  const [sampleAnswerSwitch, setSampleAnswerSwitch] = useState(false);
...
disabled={question.report_counter}
                ...
                <div className="form-group row">
                  <div className="col-lg-12">
                    <Field
                      name="sampleAnswerSwitch"
                      component={Switch}
                      mandatory={false}
                      label="Upload Model Answer Audio"
                      checked={sampleAnswerSwitch}
                      onChange={(e) => {
                        setSampleAnswerSwitch(e.target.checked);
                      }}
                    />
                  </div>
                </div>
