...
const dispatch = useDispatch();
  const questionsUIEvents = {
    newQuestionButtonClick: () => {
      history.push("/reading/rw-fill-in-the-blanks/new");
    },
    openEditQuestionDialog: (id) => {
      history.push(`/reading/rw-fill-in-the-blanks/${id}/edit`);
    },
    openAddToMockDialog: (id) => {
      history.push(`/reading/rw-fill-in-the-blanks/${id}/add-to-mock-test`);
    },
    openDeleteQuestionDialog: (id) => {
      history.push(`/reading/rw-fill-in-the-blanks/${id}/delete`);
    },
    openDeleteQuestionsDialog: () => {
      history.push(`/reading/rw-fill-in-the-blanks/deleteCustomers`);
    },
    openFetchQuestionsDialog: () => {
      history.push(`/reading/rw-fill-in-the-blanks/fetch`);
    },
    openUpdateQuestionsStatusDialog: () => {
      history.push("/reading/rw-fill-in-the-blanks/updateStatus");
    },
  };
  ...
  return (
    <QuestionsUIProvider questionsUIEvents={questionsUIEvents}>
      ...
      <Switch>
        <Route path="/reading/rw-fill-in-the-blanks/new">
          {({ history, match }) => (
            <QuestionEditDialog
              show={match != null}
              onHide={() => {
                ...
                history.push("/reading/rw-fill-in-the-blanks");
              }}
            />
          )}
        </Route>
        <Route path="/reading/rw-fill-in-the-blanks/:id/edit">
          {({ history, match }) => (
            <QuestionEditDialog
              show={match != null}
        ...
        <Route path="/reading/rw-fill-in-the-blanks/:id/add-to-mock-test">
          {({ history, match }) => (
        ...
        <Route path="/reading/rw-fill-in-the-blanks/deleteCustomers">
          {({ history, match }) => (
        ...
        <Route path="/reading/rw-fill-in-the-blanks/:id/delete">
          {({ history, match }) => (
        ...
        <Route path="/reading/rw-fill-in-the-blanks/fetch">
          {({ history, match }) => (
        ...
        <Route path="/reading/rw-fill-in-the-blanks/updateStatus">
          {({ history, match }) => (
