...
const dispatch = useDispatch();
  const questionsUIEvents = {
    newQuestionButtonClick: () => {
      history.push("/reading/r-fill-in-the-blanks/new");
    },
    openEditQuestionDialog: (id) => {
      history.push(`/reading/r-fill-in-the-blanks/${id}/edit`);
    },
    openDeleteQuestionDialog: (id) => {
      history.push(`/reading/r-fill-in-the-blanks/${id}/delete`);
    },
    openAddToMockDialog: (id) => {
      history.push(`/reading/r-fill-in-the-blanks/${id}/add-to-mock-test`);
    },
    openDeleteQuestionsDialog: () => {
      history.push(`/reading/r-fill-in-the-blanks/deleteCustomers`);
    },
    openFetchQuestionsDialog: () => {
      history.push(`/reading/r-fill-in-the-blanks/fetch`);
    },
    openUpdateQuestionsStatusDialog: () => {
      history.push("/reading/r-fill-in-the-blanks/updateStatus");
    },
  };
  ...
  return (
    <QuestionsUIProvider questionsUIEvents={questionsUIEvents}>
      ...
      <Switch>
        <Route path="/reading/r-fill-in-the-blanks/new">
          {({ history, match }) => (
            <QuestionEditDialog
              show={match != null}
              onHide={() => {
                ...
                history.push("/reading/r-fill-in-the-blanks");
              }}
            />
          )}
        </Route>
        <Route path="/reading/r-fill-in-the-blanks/:id/edit">
          {({ history, match }) => (
            <QuestionEditDialog
              show={match != null}
        ...
        <Route path="/reading/r-fill-in-the-blanks/:id/add-to-mock-test">
          {({ history, match }) => (
        ...
        <Route path="/reading/r-fill-in-the-blanks/deleteCustomers">
          {({ history, match }) => (
        ...
        <Route path="/reading/r-fill-in-the-blanks/:id/delete">
          {({ history, match }) => (
        ...
        <Route path="/reading/r-fill-in-the-blanks/fetch">
          {({ history, match }) => (
        ...
        <Route path="/reading/r-fill-in-the-blanks/updateStatus">
          {({ history, match }) => (
