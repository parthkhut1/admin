...
export function createQuestion(question) {
  delete question["id"];
  // if (question.tilte === "") delete question["tilte"];
...
export function findQuestions(queryParams) {
  ...
  qp["filter[question_type]"] = "ReadingMultipleChoiceSingleAnswer";
...
export function batchInserQuestion(file) {
  return axios.post(`/questions/batch`, file);
}
